...
picture-hint = JPEG, PNG eller WebP, upp till 40 MB. Sparas som JPEG; stora bilder skalas ned till 2048 px.
...
picture-too-large = Bilden är för stor. Gränsen är 40 MB.
