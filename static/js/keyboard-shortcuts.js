...
(function() {
    ...
    window.showShortcutsHelp = function() {
        ...
        modal.innerHTML = `
            <div class="bg-surface rounded-2xl shadow-xl max-w-2xl w-full mx-4 max-h-[80vh] overflow-hidden">
                <div class="p-6 border-b border-line flex justify-between items-center">
                    <h2 class="text-xl font-bold text-text">Keyboard Shortcuts</h2>
                    <button onclick="closeShortcutsHelp()" class="text-faint hover:text-text">
